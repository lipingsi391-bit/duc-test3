...
FIXED_TAGS = "#加州多明尼克大学 #人工智能 #人工智能硕士 #布克终身学习 #布克硕博 #加州多明尼克大学开学典礼 #开学典礼 #AI #开学季"
...
STYLE_VARIATIONS = [
    "更像真实种草帖，语气自然，不夸张。",
    "更像开学典礼后的新生感受，有现场感和情绪起伏。",
    "更像拿到 offer 后终于来到现场的真实分享，带一点喜悦。",
    "更像见到同学后写下的开学笔记，带出终身学习的感受。",
]

ANGLE_POOL = {
    "拿到offer的激动与喜悦": "写从拿到 offer 到来到开学典礼现场的喜悦。",
    "开学典礼的现场见闻": "写现场氛围、认识新同学或行业前辈的感受。",
    "选择加州多明尼克大学的原因": "写为什么最后选择这所学校。",
    "选择人工智能MBA专业的初衷": "写为什么读人工智能 MBA。",
    "对终身学习的理解与期待": "写对持续成长和长期学习的理解。",
...
3. 正文必须以第一人称来写，像本人随手写的开学笔记，口吻自然、真实、轻口语。
...
5. 可以带少量真实院校亮点，但不要写成大段资料罗列。
6. 正文不要重复输出标题。
7. body 最后一行不要再追加别的话，只保留固定 tags 前的正文收尾。
"""
